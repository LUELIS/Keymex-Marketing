            ...
            <div class="bg-gradient-to-b from-keymex-red to-[#8B1120] text-white flex flex-col h-full rounded-3xl shadow-2xl overflow-hidden">
                ...
                <nav class="flex-1 px-3 py-3 space-y-1 overflow-y-auto">
                    ...
                    <div class="pt-3 mt-2 border-t border-white/20">
                        ...
                        <a href="{{ route('settings.signatures') }}"
                           class="{{ request()->routeIs('settings.signatures') ? 'bg-white/20 shadow-lg' : 'hover:bg-white/10' }} flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm text-white font-medium transition-all duration-200">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="lg:hidden fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-keymex-red to-[#8B1120] text-white shadow-lg">
            ...
            <div id="mobile-menu" class="hidden border-t border-white/20">
                <nav class="px-4 py-4 space-y-1">
                    ...
                    <a href="{{ route('settings.signatures') }}"
                       class="{{ request()->routeIs('settings.signatures') ? 'bg-white/20' : '' }} flex items-center gap-3 px-4 py-3 rounded-xl text-white font-medium">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/>
                        </svg>
                        Signatures
