                    ...
                    <div class="relative">
                        ...
                        <div class="mt-4 space-y-1">
                            <div class="flex items-baseline gap-2">
                                ...
                                <span class="text-3xl font-bold tracking-tight">{{ number_format($compromisData['current']['total_commission_ht'], 2, ',', ' ') }}</span>
                                <span class="text-xl font-medium">&euro;</span>
                            </div>
                            <div class="flex items-baseline gap-2">
                                <span class="text-sm text-white/70">TTC :</span>
                                <span class="text-2xl font-semibold tracking-tight text-white/90">{{ number_format($compromisData['current']['total_commission'], 2, ',', ' ') }}</span>
                                <span class="text-lg font-medium text-white/80">&euro;</span>
                            </div>
                        </div>
                ...
                <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
                    ...
                    <div class="mt-4 space-y-1">
                        <div class="flex items-baseline gap-2">
                            ...
                            <span class="text-2xl font-bold text-gray-900">{{ number_format($compromisData['lastYear']['total_commission_ht'], 2, ',', ' ') }}</span>
                            <span class="text-lg font-medium text-gray-500">&euro;</span>
                        </div>
                        <div class="flex items-baseline gap-2">
                            <span class="text-sm text-gray-400">TTC :</span>
                            <span class="text-xl font-semibold text-gray-600">{{ number_format($compromisData['lastYear']['total_commission'], 2, ',', ' ') }}</span>
                            <span class="text-base font-medium text-gray-400">&euro;</span>
                        </div>
                    </div>
