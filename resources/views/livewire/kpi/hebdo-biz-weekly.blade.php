<div>
    ...
    <div class="mt-8">
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                <div class="p-6">
                    ...
                    @if($variations['compromis_ca_vs_previous'] !== null)
                        <p class="mt-2 text-sm font-medium {{ $variations['compromis_ca_vs_previous'] >= 0 ? 'text-green-600' : 'text-red-600' }}">
                            ...
                            @endif
                            {{ $variations['compromis_ca_vs_previous'] > 0 ? '+' : '' }}{{ $variations['compromis_ca_vs_previous'] }}% vs S-1
                        </p>
                    @endif
                </div>
            </div>
            ...
            <div class="bg-white shadow rounded-lg overflow-hidden">
                <div class="bg-gray-100 px-4 py-3">
                    <h3 class="text-sm font-medium text-gray-700">Meme semaine N-1</h3>
                    <p class="text-xs text-gray-500">{{ $lastYearWeek['start']->format('d/m/Y') }} - {{ $lastYearWeek['end']->format('d/m/Y') }}</p>
                </div>
                <div class="p-6">
                    <p class="text-2xl font-bold text-gray-700">
                ...
                <div class="p-6">
                    ...
                    @if($variations['mandates_vs_previous'] !== null)
                        <p class="mt-2 text-sm font-medium {{ $variations['mandates_vs_previous'] >= 0 ? 'text-green-600' : 'text-red-600' }}">
                            ...
                            @endif
                            {{ $variations['mandates_vs_previous'] > 0 ? '+' : '' }}{{ $variations['mandates_vs_previous'] }}% vs S-1
                        </p>
                    @endif
                </div>
            </div>
